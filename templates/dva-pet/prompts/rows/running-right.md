Create one horizontal animation strip for Codex pet `d-va`, state `running-right`.
...
Identity: same pet in every frame: Mascot-safe pet inspired by a futuristic tank-class mech pilot: compact chibi body, pink and teal armor hoodie, bunny ear headset, cheek stripe markings, gamer-pilot confidence, tiny mech booster details, no logos or direct Overwatch costume copy, readable whole-body silhouette, non-pixel polished 3D toy style.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: Cute glossy toy finish, bold silhouette, arcade sci-fi details, expressive eyes, bunny icon motif without text..
